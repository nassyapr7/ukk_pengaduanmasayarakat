                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                                <select class="" name="level" id="level">
                                    ...
                                    <option value="admin" {{ old('level', @$petugas->level)=="admin" ? 'selected='.'"'.'selected'.'"' : '' }}>admin</option>
                                    <option value="petugas"  {{ old('level', @$petugas->level)=="petugas" ? 'selected='.'"'.'selected'.'"' : '' }}>petugas</option>
                                </select>
                            </div>
                </div>
                <div class="form-group">
